...
img1 = cv2.imread('/home/oongking/Research_ws/src/hole_detector/data/hikrobot/ray/ray5.bmp',) 
img2 = cv2.imread('/home/oongking/Research_ws/src/hole_detector/data/hikrobot/ray/ray6.bmp',) 
...
ray1 = cv2.imread('/home/oongking/Research_ws/src/hole_detector/data/hikrobot/ray/ray5_1.bmp',) 
ray2 = cv2.imread('/home/oongking/Research_ws/src/hole_detector/data/hikrobot/ray/ray6_1.bmp',) 
rays = [ray1,ray2]
ray_point = []
...
for img in rays:
    ...
    while True:
        ...
        if waitkeyboard & 0xFF==ord('a'):
            ...
            waitkeyboard = cv2.waitKey(2000)
            break

plane_nor = np.asarray(plane_nor)
plane_origin = np.asarray(plane_origin)

print(f"plane_nor : {plane_nor[0]}")
print(f"plane_origin : {plane_origin[0]}")
# print(f"ray_point : {ray_point[0]}")
...
if points3D_1 is not None and points3D_2 is not None:
