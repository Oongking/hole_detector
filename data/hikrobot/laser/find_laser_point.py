...
for i in range(5,9):
    img = cv2.imread(f'/home/oongking/Research_ws/src/hole_detector/data/hikrobot/laser/{i}.png',) 
...
print(f"points3D_1 : {points3D_1}")
print(f"points3D_2 : {points3D_2}")
print(f"points3D_3 : {points3D_3}")
print(f"points3D_4 : {points3D_4}")
