...
pcd = o3d.io.read_point_cloud('/home/oongking/Research_ws/src/hole_detector/data/room/mock_test/mock1cm_7.pcd')
...
class Hole_detector:
    ...
    def Cluster_hole(self,pcd, Clus_eps=0.005, Clus_min_points=5, Out_nb_neighbors = 20, Out_std_ratio = 1.0, point_upper_limit = 100, point_lower_limit = 50, obj_size = 0.05):
        pcds = []
